let url ="http://140.238.154.188:8082/api/Category/all";
...
function editar(id) {
  ...
  url ="http://140.238.154.188:8082/api/Category";
...
function guardarNuevo() {
  ...
  url = "http://140.238.154.188:8082/api/Category/save";         
...
function guardarEditar() {
  ...
  //convierto el objeto de javascript a formato json
  let objetoJson = JSON.stringify(objeto)
  url ="140.238.154.188:8082/api/Category/update";
...
function guardarBorrar() {
  ...
  */
  ...
  let url = "140.238.154.188:8082/api/Category/delete";
