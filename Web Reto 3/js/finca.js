...
let url = "http://140.238.154.188:8082/api/Farm/all"
...
function editar(id) {
  ...
  url = "http://140.238.154.188:8082/api/Farm";
...
function eliminar(id) {
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  let url = "http://140.238.154.188:8082/api/Farm";
...
function guardarNuevo() {
  ...
  url = "http://140.238.154.188:8082/api/Farm/save";
...
function guardarEditar() {
  ...
  url = "http://140.238.154.188:8082/api/Farm/update";
...
function guardarBorrar() {
  ...
  */
  ...
  url = "http://140.238.154.188:8082/api/Farm/delete";
...
function traecategorias(){
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  url = "http://140.238.154.188:8082/api/Category/all";
  let id;
  let nombre;
  let respuesta;
  /*2 propiedad onreadystatechange asigna a una funcion
