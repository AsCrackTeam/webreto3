...
let url="http://140.238.154.188:8082/api/Messages/all"
...
function editar(id) {
    ...
    url = "http://140.238.154.188:8082/api/Message"
...
function eliminar(id) {
    let url = "http://140.238.154.188:8082/api/Message"
...
function guardarNuevo() {
    ...
    url = "http://140.238.154.188:8082/api/Message/save";
...
function guardarBorrar() {
    let url = "http://140.238.154.188:8082/api/Message/delete"
...
function traerdatos() {
    let registros = ""
    let id = ""
    url="http://140.238.154.188:8082/api/Messages/all"
...
function traefincas(){
    //1 crear un objeto XMLHttpRequest
    let peticion = new XMLHttpRequest();
    url = "http://140.238.154.188:8082/api/Farm/all";
    let id;
    let nombre;
    let respuesta;
    /*2 propiedad onreadystatechange asigna a una funcion
...
function traeclientes(){
    //1 crear un objeto XMLHttpRequest
    let peticion = new XMLHttpRequest();
    url = "http://140.238.154.188:8082/api/Client/all";
    let id;
    let nombre;
    let respuesta;
    /*2 propiedad onreadystatechange asigna a una funcion
